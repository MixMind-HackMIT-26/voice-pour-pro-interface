...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "MixMind" },
      { name: "description", content: "Voice-matched drinks, mixed in the moment." },
      { name: "author", content: "MixMind" },
      { property: "og:title", content: "MixMind" },
      { property: "og:description", content: "Voice-matched drinks, mixed in the moment." },
